...
btncamera = Button(root, image=camera, text="Save", command=lambda: put_sprite(5))
...
btn1 = Button(root, image=photo1, text="Hat", command=lambda: put_sprite(0))
...
btn2 = Button(root, image=photoimage2, text="Mustache", command=lambda: put_sprite(1))
...
btn3 = Button(root, image=photoimage3, text="Flies", command=lambda: put_sprite(2))
...
btn4 = Button(root, image=photoimage4, text="Glasses", command=lambda: put_sprite(3))
...
btn5 = Button(root, image=photoimage5, text="Doggy", command=lambda: put_sprite(4))
btn5.pack(side="left", fill="both", expand="no", padx="5", pady="5")

logout = PhotoImage(file="/home/dishit/final_test/button/close.png")
btnlogout = Button(root, image=logout, text="Close", command=lambda: terminate())
...
BTNS = [btn1, btn2, btn3, btn4, btn5, btnlogout]
